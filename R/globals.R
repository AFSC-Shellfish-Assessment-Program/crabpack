utils::globalVariables(c(read.csv("inst/extdata/metadata.csv")$Field,
                         '.', 'expand_combos', 'N_POS_STATION', 'TOTAL_AREA_POS', 'bin_combos',
                         ...
                         'MEAN_CPUE_MT', 'data', 'CPUE_KG', 'AREA', 'HT', 'RANGE', 'REMOVE', 'Field',
                         'TOTAL_CPUE'))
