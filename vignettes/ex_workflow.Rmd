...
## Note: for each example, please verify that you have the appropriate species data loaded

  # Example 1: Mature female Bristol Bay Red King Crab using ADF&G cutlines
  ...
  # Example 2: Male St. Matthew district Blue King Crab between 105 and 199mm
